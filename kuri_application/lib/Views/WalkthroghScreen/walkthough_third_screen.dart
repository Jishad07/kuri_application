...
class WalkthroughTHirdScreen extends StatelessWidget {
  @override
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/moneybackgroundimage3.jpg"),
              ...
              children: [
                Padding(
                  ...
                  child: IconButton(
                    onPressed: () {
                      // Get.off(LoginScreen());
                      Get.to(LoginScreen(),transition: Transition.rightToLeft,duration: Duration(milliseconds: 700));
                    },
                    icon: Icon(
                      Icons.arrow_forward,
                      color: Colors.amber, 
